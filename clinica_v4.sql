...
-- Volcando datos para la tabla clinica.antecedente_clinico: ~2 rows (aproximadamente)
INSERT INTO `antecedente_clinico` (`id`, `id_paciente`, `id_antecedente_clinico`, `respuesta`, `usuario`, `observaciones`, `created_time`, `update_time`) VALUES
	(243, 180, 2, 'Si', 'SISTEMA', 'dgdfg', '2024-05-30 18:02:11.949275', '2024-05-30 18:02:11.949275'),
	(244, 181, 2, NULL, 'SISTEMA', NULL, NULL, NULL);
...
-- Volcando datos para la tabla clinica.aparato_sistemas: ~2 rows (aproximadamente)
INSERT INTO `aparato_sistemas` (`id`, `id_paciente`, `id_aparato_sistema`, `respuesta`, `usuario`, `observaciones`, `create_time`, `update_time`, `clave`, `descripcion`) VALUES
	(43, 180, 1, '0', 'SISTEMA', 'x', '2024-05-31 00:01:53', '2024-05-31 00:04:03', NULL, NULL),
	(44, 181, 1, 'xgf', 'SISTEMA', 'dgfdgf', '2024-05-31 00:08:46', '2024-05-31 00:10:42', NULL, NULL);
...
-- Volcando datos para la tabla clinica.examen_fisico: ~2 rows (aproximadamente)
INSERT INTO `examen_fisico` (`id`, `id_paciente`, `id_examen_fisico`, `respuesta`, `resultado`, `observaciones`, `usuario`, `update_time`, `create_time`) VALUES
	(34, 180, 1, NULL, NULL, NULL, 'SISTEMA', '2024-05-31 00:01:53', '2024-05-31 00:01:53'),
	(35, 181, 1, NULL, NULL, NULL, 'SISTEMA', '2024-05-31 00:08:46', '2024-05-31 00:08:46');
...
-- Volcando datos para la tabla clinica.examen_laboratorio: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla clinica.paciente: ~2 rows (aproximadamente)
INSERT INTO `paciente` (`id`, `fecha`, `cue`, `id_tipo_examen`, `recomendacion`, `apto_laborar`, `fecha_vencimiento`, `update_time`, `create_time`, `usuario`) VALUES
	(180, '2024-05-01', 1281, 1, '', 0, NULL, NULL, '2024-05-31 00:01:53', NULL),
	(181, '2024-05-08', 1281, 0, '', 0, NULL, NULL, '2024-05-31 00:08:46', NULL);
...
-- Volcando datos para la tabla clinica.signo_vital: ~2 rows (aproximadamente)
INSERT INTO `signo_vital` (`id`, `id_paciente`, `id_signo_vital`, `respuesta`, `observaciones`, `usuario`, `create_time`, `update_time`) VALUES
	(35, 180, 1, 'gfg', 'dfgdfg', 'SISTEMA', '2024-05-31 00:01:53', '2024-05-31 00:02:22'),
	(36, 181, 1, NULL, NULL, 'SISTEMA', '2024-05-31 00:08:46', '2024-05-31 00:08:46');
